...
//		this.workflows[this.workflows.length - 1].addInstruction(new EndInstruction());
		...
		this.workflows = new Workflow[2];
		for(int i = 0; i<this.workflows.length; i++) {
			this.workflows[i] = new Workflow(this, getModel().getImageSelection()[i]);
			this.workflows[i].addInstruction(new DrawRoiInstruction("Test",
																	new ImageState(Orientation.POST, 2, ImageState.LAT_RL,
																				   ImageState.ID_WORKFLOW)));
			this.workflows[i].addInstruction(new DrawRoiInstruction("Test2",
																	new ImageState(Orientation.POST, 2,
																				   ImageState.LAT_RL,
																				   ImageState.ID_WORKFLOW)));
			this.workflows[i].addInstruction(new DrawRoiInstruction("Test3",
																	new ImageState(Orientation.POST, 2, ImageState.LAT_RL,
																				   ImageState.ID_WORKFLOW)));
		}
