...
public class DrawSymmetricalRoiInstruction extends DrawRoiInstruction {
	...
	/**
	 * 
	 * This Instruction draw a roi symmetrically from the width/2 or width/4 of the image.<br/>
	 * It take exemple from the ROI of the given Instruction.<br/>
	 * This Instruction was designed for the {@link CardiacScintigraphy}.
	 * 
	 * @param organToDelimit		Name of organ. This will automatically add A for ANT and P for POST when the ROI is validated
