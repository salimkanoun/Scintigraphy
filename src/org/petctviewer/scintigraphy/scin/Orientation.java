...
public enum Orientation {
	...
	/**
	 * Checks if the orientation possessed both Ant and Post images.<br>
	 * This mean this method returns TRUE for the following orientations:
	 * <ul>
	 * <li>ANT_POST</li>
	 * <li>POST_ANT</li>
	 * <li>DYNAMIC_ANT_POST</li>
	 * <li>DYNAMIC_POST_ANT</li>
	 * </ul>
	 * And this method returns false for every other orientation.
	 *
	 * @return TRUE if the orientation has Ant and Post and FALSE otherwise
	 */
	public boolean hasBothFacingOrientations() {
		return this == ANT_POST || this == POST_ANT || this == DYNAMIC_ANT_POST || this == DYNAMIC_POST_ANT;
	}
	...
	public static Orientation parse(String display) {
		for (Orientation o : Orientation.values()) {
			if (o.toString().equals(display)) return o;
		}
		return null;
	}
