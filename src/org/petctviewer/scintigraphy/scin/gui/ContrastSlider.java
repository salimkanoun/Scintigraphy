...
////				this.reference.getStack().setProcessor(this.reference.getStack().getProcessor(i).resize(IMG_WIDTH), i);
...
//			}
			...
			IJ.run(this.reference, "Size...", "width="+IMG_WIDTH+" height="+IMG_WIDTH+" depth=2 constrain average interpolation=Bilinear");
