...
public class Library_Capture_CSV {
	...
	public static HashMap<String, String> getPatientInfo(ImagePlus imp) {
		...
		if (tagId != null) hm.put(PATIENT_INFO_ACCESSION_NUMBER, tagId.trim());
	...
	public static String getTagPartie1(HashMap tags, String nomProgramme, String uid) {
		...
		tag += "0020,000D Study Instance UID:" + tags
				.get("0020,000D") + "\n" + "0020,000E Series Instance UID:" + ((String) tags.get("0020,000E"))
				.substring(0, ((String) tags.get("0020,000E")).length() - 6) + uid + "\n";
		...
		tag += "0020,0011 Series Number: 1337" + "\n" + "0020,0013 Instance Number: 1" + "\n" + "0020,0032 Image " +
				"Position (Patient):" + tags
				.get("0020,0032") + "\n" + "0020,0037 Image Orientation (Patient):" + tags
	...
	public static void exportRoiManager(RoiManager Roi, String nomProgramme, ImagePlus imp) {
		...
		if (path != null && testEcriture) {
			...
			if (subDirectory.mkdirs()) {
				...
				System.err.println(
						"An error occurred when trying to create directories for the path: " + pathFinal + ". Aborting" +
								" creation of ZIP.");
			}
		}
	}
...
//			}
				...
				System.err.println("An error occurred while trying to create the directories for the path: " + pathFinal + ". Aborting creation of CSV, ZIP and JPEG.");
			}
		}
	}
