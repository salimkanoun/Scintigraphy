...
public class Controleur_VG_Roi implements ActionListener {
	...
	public void actionPerformed(ActionEvent arg0) {
		...
		if (b == laVue.lesBoutons.get("Suivant")) {
			...
			case ESTOMAC_ANT:	
				...
				tagCaptureFinale=StaticMethod.genererDicomTagsPartie1(laVue.imp, laVue.nomProgramme);
			...
			case INTESTIN_POS:
				...
				ImagePlus captureTemp=StaticMethod.captureImage(laVue.imp, 512, 512);
			...
			case FIN:
				...
				ImageStack stackCapture=StaticMethod.captureToStack(capture);
	...
	if(b==laVue.lesBoutons.get("Sauvegarder")) {
		...
		ImagePlus ze = StaticMethod.captureFenetre(laVue.res.getImagePlus(), 0, 0);
		laVue.leRoi.close();
		...
		tagCaptureFinale += StaticMethod.genererDicomTagsPartie2(ze);
		...
		try {
			StaticMethod.exportAll(resultats, 4, laVue.leRoi, laVue.nomProgramme, ze);
