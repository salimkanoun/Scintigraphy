...
public class ModelMIBG extends ModelScin {
	...
	public void calculateResults() {
		for (int indexImage = 0; indexImage < 2; indexImage++) {
			...
			for (int indexRoi = 0; indexRoi < 2; indexRoi++) {
				...
				System.out.println(ORGANS[indexImage * 2 + indexRoi]+" : "+Library_Quantif.getAvgCounts(ims.getImagePlus()));
			}
		}
		...
		this.dataImage.put("Washout Rate", (this.dataImage.get("Early H/M ratio") - this.dataImage.get("Late H/M ratio"))/ this.dataImage.get("Early H/M ratio"));
