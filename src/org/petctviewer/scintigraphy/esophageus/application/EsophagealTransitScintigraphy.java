...
public class EsophagealTransitScintigraphy extends Scintigraphy {
	/*
	...
	public EsophagealTransitScintigraphy() {
	...
	public void start(List<ImageSelection> preparedImages) {
		...
		ControllerWorkflowEsophagealTransit cet = new ControllerWorkflowEsophagealTransit(
				(FenApplicationWorkflow) EsophagealTransitScintigraphy.this.getFenApplication(), new Model_EsophagealTransit(
				sauvegardeImagesSelectDicom, "Esophageal " + "Transit", EsophagealTransitScintigraphy.this,
	...
	public List<ImageSelection> prepareImages(List<ImageSelection> selectedImages)
		...
		if (imagePourTrieAnt.size() > 0) {
			...
			Library_Gui.initOverlay(impProjeteAllAcqui);
