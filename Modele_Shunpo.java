...
public class Modele_Shunpo {
	...
	protected void calculerCoups(String roi, ImagePlus imp) {
		...
		// ParticleAnalyzer(measurements,options,rt,0,1000000);
		// pa.analyze(imp);
		// double coups2=rt.getValue("INTEGRATED_DENSITY", 0);
		// IJ.log("ResultTable"+String.valueOf(coups2));
		if (roi.contains("BDF"))
	...
	public static String genererDicomTagsPartie1(ImagePlus imp, String nomProgramme) {
		String sopID = BrownFat.generateSOPInstanceUID(new Date());
		String uid = myWriteDicom.generateUID6digits();
